// Generated on 2014-11-26 using generator-angular 0.6.0-rc.2
'use strict';
        ...
        less: {
            development: {
                options: {
                    compress: true,
                    sourceMap: true,
                    sourceMapFilename: '<%= yeoman.app %>/styles/build/parking-check.css.map',
                    sourceMapBasepath: '<%= yeoman.app %>/styles/build/'
                },
                files: {
                    'app/styles/build/parking-check.css': 'app/styles/parking-check.less'
                }
            }
        },
